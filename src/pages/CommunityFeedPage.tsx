  ...
  return (
    <div className="min-h-screen flex flex-col bg-urban-eye-pink text-white">
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-4 text-center">
        <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full text-gray-800"> {/* Changed max-w-xl back to max-w-md */}
          ...
          <div className="grid grid-cols-1 gap-4 w-full"> {/* Changed to grid-cols-1 to stack vertically */}
